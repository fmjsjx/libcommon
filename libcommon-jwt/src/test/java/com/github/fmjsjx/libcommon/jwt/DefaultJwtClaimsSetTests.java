...
public class DefaultJwtClaimsSetTests {
    ...
    public void testToString() {
        assertEquals("DefaultJwtClaimsSet({})", createEmpty().toString());
        assertEquals("DefaultJwtClaimsSet(" + new String(TEST_RAW_JSON, StandardCharsets.UTF_8) + ")", createTest().toString());
    }
